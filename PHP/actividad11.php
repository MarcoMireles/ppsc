...
<form action="actividad11.php" method="get">
  <label for="cant">Ingresa la cantidad de datos que desas capturar</label>
  <input type="number" id="cant" name="cant" required>

  <button type="submit">Generar Inputs</button>
</form>
...
<?php
  ...
  function generar($cant){
    ...
    for ($i = 0; $i < $cant; $i++){
      echo $i;
      echo '<input type="number" name="vector[]" id="input-'.$i.'" required> <br>';
    }
